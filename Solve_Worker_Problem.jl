...
function compute_worker_value(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, c::Float64, α::Float64, H_prime::Float64, H_prime_index::Int64, D::Float64, FC::Int64, interp_functions::Vector{Any}, para::Model_Parameters )
    @unpack_Model_Parameters para
...
function optimize_worker_c(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, α::Float64, H_prime::Float64, H_prime_index::Int64, D::Float64, FC::Int64, interp_functions::Vector{Any}, para::Model_Parameters)
    @unpack_Model_Parameters para
    ...
    if c_max_case < 0
        ...
        result = optimize(c -> -compute_worker_value(j, H, P,  X, η_index, Inv_Move, c, α, H_prime, H_prime_index, D, FC, interp_functions, para), 0.0, c_max_case, Brent())
...
function objective_worker_D(D::Float64, j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, α::Float64, H_prime::Float64, 
...
function optimize_worker_d(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, α::Float64, H_prime::Float64, H_prime_index::Int64, FC::Int64, interp_functions::Vector{Any}, para::Model_Parameters)
    @unpack_Model_Parameters para
    # Find maximum feasible consumption
    ...
    # Optimize using Brent's method
    result = optimize(D -> -objective_worker_D(D, j, H, P,  X, η_index, Inv_Move, α, H_prime, H_prime_index, FC, interp_functions, para), 0.0, D_max_case, Brent())
    D_opt = Optim.minimizer(result)

    c_opt = optimize_worker_c(j, H, P, X, η_index, Inv_Move,α, H_prime, H_prime_index, D_opt, FC, interp_functions, para)
