                            ...
                            if IFC == 1
                                ...
                                for H_prime_index in 1:nH 
                                    ...
                                    for α_index in 1:nα 
                                        ...
                                        if  α < 1.0
                                            D = 0.0 
                                            c = optimize_worker_c(j, H, P, X, η_index, Inv_Move, α, H_prime, H_prime_index, D, IFC, FC, interp_functions, para)
                                            val = compute_worker_value(j, H, P,  X, η_index, Inv_Move, c, α, H_prime, H_prime_index, D, IFC, FC, interp_functions, para)
                                        else
                                            D, c, val = optimize_worker_d(j, H, P, X, η_index, Inv_Move, α, H_prime, H_prime_index, IFC, FC, interp_functions, para)
                                        end 
...
function compute_worker_value(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, 
    ...
    for η_prime_index in eachindex(η_grid)
        ...
        for ω_prime_index in eachindex(ω_grid)
            ...
            for ι_prime_index in eachindex(ι_grid)
...
function optimize_worker_c(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, α::Float64, H_prime::Float64, H_prime_index::Int64, D::Float64, IFC::Int64, FC::Int64, interp_functions::Vector{Any}, para::Model_Parameters)
    @unpack_Model_Parameters para
...
function optimize_worker_d(j::Int64, H::Float64, P::Float64, X::Float64, η_index::Int64, Inv_Move::Int64, α::Float64, H_prime::Float64, H_prime_index::Int64,IFC::Int64, FC::Int64, interp_functions::Vector{Any}, para::Model_Parameters)
    @unpack_Model_Parameters para
    # Find maximum feasible consumption
